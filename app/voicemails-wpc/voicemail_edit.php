...
//show the content
	...
	if (permission_exists('voicemail_escalation_add') || permission_exists('voicemail_escalation_edit')) {
		...
		for ($c = 0; $c < 1; $c++) {
			...
			echo "</td>\n";
			echo "<td class='vtable' align='left'>\n";
			echo "  <input class='formfld' style='width:70px' type='text' pattern='^\d{1-4}$' name='voicemail_escalations[".$c."][voicemail_escalation_delay]' maxlength='4' value='0' required>\n";
			echo "</td>\n";
			echo "<td class='vtable' align='left'>\n";
