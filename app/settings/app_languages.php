...
$text['label-event_socket_listen_ip']['en-us'] = "Event Socket Listen Address";
$text['label-event_socket_listen_ip']['en-gb'] = "Event Socket Listen Address";
$text['label-event_socket_listen_ip']['ar-eg'] = "";
$text['label-event_socket_listen_ip']['de-at'] = "Event Socket Listen Adresse"; //copied from de-de
$text['label-event_socket_listen_ip']['de-ch'] = "Event Socket Listen Adresse"; //copied from de-de
$text['label-event_socket_listen_ip']['de-de'] = "Event Socket Listen Adresse";
$text['label-event_socket_listen_ip']['es-cl'] = "Dirección IP del Socket de Eventos";
$text['label-event_socket_listen_ip']['es-mx'] = "Dirección IP del Socket de Eventos"; //copied from es-cl
$text['label-event_socket_listen_ip']['fr-ca'] = "Adresse IP pour Event Socket"; //copied from fr-fr
$text['label-event_socket_listen_ip']['fr-fr'] = "Adresse IP pour Event Socket";
$text['label-event_socket_listen_ip']['he-il'] = "";
$text['label-event_socket_listen_ip']['it-it'] = "IP Address Event Socket";
$text['label-event_socket_listen_ip']['nl-nl'] = "Event-Socket IP adres";
$text['label-event_socket_listen_ip']['pl-pl'] = "Adres IP 'Event Socket'";
$text['label-event_socket_listen_ip']['pt-br'] = "Endreço IP do Evento Socket ";
$text['label-event_socket_listen_ip']['pt-pt'] = "Endreço IP do Event Socket";
$text['label-event_socket_listen_ip']['ro-ro'] = "";
$text['label-event_socket_listen_ip']['ru-ru'] = "IP Address сокета событий";
$text['label-event_socket_listen_ip']['sv-se'] = "Event Socket IP Address";
$text['label-event_socket_listen_ip']['uk-ua'] = "Event Socket IP Address";
...
$text['description-event_socket_listen_ip']['en-us'] = "Enter the event socket IP listen address. default: 127.0.0.1";
$text['description-event_socket_listen_ip']['en-gb'] = "Enter the event socket IP listen address. default: 127.0.0.1";
$text['description-event_socket_listen_ip']['ar-eg'] = "";
$text['description-event_socket_listen_ip']['de-at'] = "Geben Sie die Event Socket IP Addresse an. Standard: 127.0.0.1"; //copied from de-de
$text['description-event_socket_listen_ip']['de-ch'] = "Geben Sie die Event Socket IP Addresse an. Standard: 127.0.0.1"; //copied from de-de
$text['description-event_socket_listen_ip']['de-de'] = "Geben Sie die Event Socket IP Addresse an. Standard: 127.0.0.1";
$text['description-event_socket_listen_ip']['es-cl'] = "Dirección IP del socket de eventos. Predeterminada: 127.0.0.1";
$text['description-event_socket_listen_ip']['es-mx'] = "Dirección IP del socket de eventos. Predeterminada: 127.0.0.1"; //copied from es-cl
$text['description-event_socket_listen_ip']['fr-ca'] = "Adresse IP pour le module Event Socket. défaut: 127.0.0.1"; //copied from fr-fr
$text['description-event_socket_listen_ip']['fr-fr'] = "Adresse IP pour le module Event Socket. défaut: 127.0.0.1";
$text['description-event_socket_listen_ip']['he-il'] = "";
$text['description-event_socket_listen_ip']['it-it'] = "Inserire l'IP address della event socket. default: 127.0.0.1";
$text['description-event_socket_listen_ip']['nl-nl'] = "Voer het Event-Socket IP adres in. Standaard 127.0.0.1";
$text['description-event_socket_listen_ip']['pl-pl'] = "Wprowadź adres IP 'Event Socket' (domyślny 127.0.0.1)";
$text['description-event_socket_listen_ip']['pt-br'] = "Introduza o endereço IP do evento socket. omissão: 127.0.0.1 ";
$text['description-event_socket_listen_ip']['pt-pt'] = "Introduza o endereço IP do event socket. omissão: 127.0.0.1";
$text['description-event_socket_listen_ip']['ro-ro'] = "";
$text['description-event_socket_listen_ip']['ru-ru'] = "Введите IP адрес сокета событий. по умолчанию: 127.0.0.1";
$text['description-event_socket_listen_ip']['sv-se'] = "Fyll i event socket IP address. default: 127.0.0.1";
$text['description-event_socket_listen_ip']['uk-ua'] = "Enter the event socket IP address. default: 127.0.0.1 ";
