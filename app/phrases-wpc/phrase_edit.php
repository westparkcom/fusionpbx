				...
				if ($action == "add" && permission_exists('phrase_add')) {
					//build data array
						...
						if ($_POST['phrase_detail_function'] != '') {
							if ($_POST['phrase_detail_function'] == 'execute' && (substr($_POST['phrase_detail_data'], 0,5) != "sleep" && substr($_POST['phrase_detail_data'], 0,20) != "\${lua streamfile.lua" && substr($_POST['phrase_detail_data'], 0,19) != "\${python streamtext") && !permission_exists("phrase_execute")) {
