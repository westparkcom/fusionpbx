...
function newgatecall(gatedata)
    ...
    local caller_destination = getvar("RDNIS") -- changed in order to compensate caller_destination
...
function run_call()
    ...
    callinfo["dnis"] = getvar("RDNIS") -- Changed in order to compensate caller_destination
