					...
					if ((strlen($this->db_type) > 0) || (strlen($this->dsn_name) > 0)) {
						...
						elseif ($this->db_type == "pgsql") {
							...
							if ($this->db_secure == true) {
								$tmp .= "	database.system = \"pgsql://".$host."=".$this->db_host." port=".$this->db_port." dbname=".$this->db_name." user=".$this->db_username." password=".$this->db_password." sslmode=verify-ca sslrootcert=".$this->db_cert_authority." application_name=fusionpbx_lua options=''\";\n";
								$tmp .= "	database.switch = \"pgsql://".$host."=".$this->db_host." port=".$this->db_port." dbname=freeswitch user=".$this->db_username." password=".$this->db_password." sslmode=verify-ca sslrootcert=".$this->db_cert_authority." application_name=fusionpbx_lua options=''\";\n";
							}
							else {
								$tmp .= "	database.system = \"pgsql://".$host."=".$this->db_host." port=".$this->db_port." dbname=".$this->db_name." user=".$this->db_username." password=".$this->db_password." application_name=fusionpbx_lua options=''\";\n";
								$tmp .= "	database.switch = \"pgsql://".$host."=".$this->db_host." port=".$this->db_port." dbname=freeswitch user=".$this->db_username." password=".$this->db_password." application_name=fusionpbx_lua options=''\";\n";
							}
						}
